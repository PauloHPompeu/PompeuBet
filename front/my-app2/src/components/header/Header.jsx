  ...
  return (
    <div id="header">
      ...
      <div id="catalogo">
        ...
        <li className="homePage">
          <Link className="homePage" to="/apostas">
            Apostas
          </Link>
        </li>
        <li className="homePage">
          <Link className="homePage" to="/saquedeposito">
            Saque/Depósito
          </Link>
        </li>
        <li className="homePage">
          <Link className="homePage" to="/listagem">
            Listagem
          </Link>
        </li>
        <li className="homePage">
          <Link className="homePage" to="/perfil">
            Meu Perfil
          </Link>
        </li>
      </div>
